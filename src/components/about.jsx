      ...
      <div className='md:p-22 md:pt-24 md:pb-22 md:px-40 md:h-full select-none bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] bg-[white] p-8 md:flex justify-normal space-x-28 md:mt-0 mt-6 pt-16'>
        <div className='md:w-6/12'>
            ...
            <div className='md:w-12/12 md:mt-10 '>
                <h1 className='font-poppins text-justify'>I’m a software developer from Dhanbad, India, with a year of hands-on experience building and learning across domains. I adapt quickly to new technologies and enjoy expanding my skill set beyond core development. With a strong attention to detail and a passion for innovation, I collaborate effectively with cross-functional teams to deliver reliable, high-quality solutions. </h1>
            </div>
        </div>
        <div className='relative md:-left-0 -left-28 md:pt-4 pt-12'>
            ...
            <div className='md:mt-4'>
                ...
                <hr className='md:w-64 w-32 md:mb-0 mb-4 md:h-1 h-1 mt-3 md:ml-10 lg:mt-1 bg-gradient-to-r from-[#c580f0ed] to-[#c580f0c8]'></hr>
                <h1 className='md:mt-4 md:ml-2 font-poppins'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>Project Building</span></h1>
                <h1 className='md:mt-4 md:ml-2 font-poppins'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>Coding</span></h1>
                <h1 className='md:mt-4 md:ml-2 font-poppins'><GoDot className='inline'/><span className='md:pl-12 text-xl pl-4'>Solving Problems</span></h1>
            </div>
        </div>
      </div>
    )
